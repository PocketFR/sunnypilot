...
from openpilot.selfdrive.ui.sunnypilot.layouts.settings.diagnostics import DiagnosticsLayout
...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    self._panels = {
      ...
      OP.PanelType.DIAGNOSTICS: PanelInfo(tr_noop("Diagnostics"), DiagnosticsLayout(), icon="icons/warning.png"),
